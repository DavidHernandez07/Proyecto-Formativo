...
<body class="animsition site-menubar-disable-hover">
    ...
    <div class="page">
        <div class="page-header">
            <h1 class="page-title">Sección para Agregar Concepto en DaAnJu</h1>
            <ol class="breadcrumb">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                @if (Auth::user()->tieneRole('Super Administrador'))
                                <form method="POSt" action="{{ route('cifs.store') }}">
                                    @csrf
                                    <div class="form-group">
                                        <h2>Concepto</h2>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="Precio" class="control-label">{{'Valor Mensual'}}</label>
