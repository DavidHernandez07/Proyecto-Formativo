...
<body class="animsition site-menubar-disable-hover">
  ...
  <div class="page-header">
    <h1 class="page-title">Lista de Cifs Registrados en DaAnJu</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a>Inicio</a></li>
      <li class="breadcrumb-item"><a>Gestion de Cifs</a></li>
  </ol>
</div>
    ...
    <div class="panel-body">
                ...
                <table>
                    <tr>
                        <td>
                            @if (Auth::user()->tieneRole('Super Administrador'))
                            <a class="btn btn-primary" href="{{ route('cifs.create') }}">Agregar Concepto</a>
                            @endif
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-hover dataTable table-striped w-full" id="exampleTableTools">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="cell-300" scope="col">Valor Mensual</th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="post" action="{{ route('cifs.destroy',['cif'=>$cs->id]) }}">
                                    @csrf
                                    {{ method_field('delete') }}
                                    <button class="btn btn-danger" type="submit" onclick="return confirm('¿Desea eliminar este concepto?');">Eliminar</button>
                                </form>
                                @endif
                            </td>
                        </tr>
