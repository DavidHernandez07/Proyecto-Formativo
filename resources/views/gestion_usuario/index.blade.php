...
<body class="animsition site-menubar-disable-hover">
  ...
  <div class="page-header">
    <h1 class="page-title">Lista de Empleados Registrados en DaAnJu</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a>Inicio</a></li>
      <li class="breadcrumb-item"><a>Gestion de Empleados</a></li>
  </ol>
</div>
...
<div class="page-content">
    ...
    <div class="panel-body">
                ...
                <table>
                    <tr>
                        <td>
                            @if (Auth::user()->tieneRole('Super Administrador'))
                            <a class="btn btn-primary" href="{{ route('gestion_usuario.create') }}">Agregar Empleado</a>
                            @endif
                             </td>
                    </tr>
                </table>
                ...
                <table class="table table-hover dataTable table-striped w-full" id="exampleTableTools">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="cell-300" scope="col">Nombre</th>
                            <th class="cell-300" scope="col">Salario</th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="post" action="{{ route('gestion_usuario.destroy',['gestion_usuario'=>$g->id]) }}">
                                    @csrf
                                    {{ method_field('delete') }}
                                    <button class="btn btn-danger" type="submit" onclick="return confirm('¿Desea eliminar este empleado?');">Eliminar</button>
                                </form>
                                @endif
                            </td>
                        </tr>
    ...
    <footer class="site-footer">
        <div class="site-footer-legal">© 2018 <a href="http://themeforest.net/item/remark-responsive-bootstrap-admin-template/11989202">DaAnJu</a></div>
