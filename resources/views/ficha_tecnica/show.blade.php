...
<body class="animsition site-menubar-disable-hover">
    ...
    <div class="page">
        <div class="page-header">
            <h1 class="page-title">Lista de Ficha Técnica Registrada en DaAnJu</h1>
            <ol class="breadcrumb">
                ...
                <div class="panel-body">
                    ...
                    <h2>Lista de Materia prima de la ficha</h2>
                        <thead>
                            <tr>
                                ...
                                <th class="cell-300" scope="col">Tipo Materia Prima</th>
                                @if (Auth::user()->tieneRole('Super Administrador'))
                                <th>Opciones</th>
                                @endif
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ route('ficha_tecnica.deleteMateriaPrima',['ficha_tecnica_id'=>$ficha_tecnica->id, 'materia_prima_id'=>$mp->id ] ) }}">
                                        @csrf
                                        {{ method_field('DELETE') }}
                                        <button class="btn btn-danger" type="submit" onclick="return confirm('¿Desea eliminar esta materia prima de la Ficha?');">Eliminar</button>
                                    </form>
                                    @endif
                                </td>
                            </tr>
                    ...
                    <h2>Lista de Mano de Obra de la ficha</h2>
                        <thead>
                            ...
                            <tr>
                                <th class="cell-300" scope="col">Id</th>
                                <th class="cell-300" scope="col">Tipo de Labor</th>
                                <th class="cell-300" scope="col">Cantidad de Tiempo</th>
                                <th class="cell-300" scope="col">Costo</th>
                                <th class="cell-300" scope="col">Tipo Mano de Obra</th>
                                @if (Auth::user()->tieneRole('Super Administrador'))
                                <th>Opciones</th>
                                @endif
                            </tr>
                        </thead>
                        <tbody> @foreach($ficha_tecnica->mano_obras as $mo)
                        <tr>
                            <td>{{$mo->id}}</td>
                            <td>{{$mo->tipo_labor}}</td>
                            ...
                            <td>
                                <form method="POST" action="{{ route('ficha_tecnica.deleteManoObra',['ficha_tecnica_id'=>$ficha_tecnica->id, 'mano_de_obra_id'=>$mo->id ] ) }}">
                                    @csrf
                                    {{ method_field('DELETE') }}
                                    <button class="btn btn-danger" type="submit" onclick="return confirm('¿Desea eliminar esta mano de obra de la Ficha?');">Eliminar</button>
                                </form>
                            </td>
                            @endif
                        </tr>
