                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <a class="btn btn-primary " href="{{ route('ficha_tecnica.create') }}">Agregar Ficha Técnica</a>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="post" action="{{ route('ficha_tecnica.destroy',['ficha_tecnica'=>$f->id]) }}">
                                    @csrf
                                    {{ method_field('delete') }}
                                    <button class="btn btn-danger" type="submit" onclick="return confirm('¿Desea eliminar la Ficha Técnica?');">Eliminar</button>
                                </form>
                                @endif
                            </td>
                        </tr>
