...
<body class="animsition site-menubar-disable-hover">
    ...
    <div class="page">
        <div class="page-header">
            <h1 class="page-title">Lista de Mano de Obra Disponible para la Ficha Técnica Registrada en DaAnJu</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a>Inicio</a></li>
                <li class="breadcrumb-item"><a>Gestion de Ficha Técnica</a></li>
                <li class="breadcrumb-item"><a>Ver</a></li>
                <li class="breadcrumb-item"><a>Lista de Mano de Obra</a></li>
            </ol>
        </div>
                                ...
                                <form method="POST" action="{{ action('FichaTecnicaController@saveManoObra') }}">
                                    ...
                                    <table class="table table-hover dataTable table-striped w-full" id="exampleTableTools">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                <th class="cell-300" scope="col">Mano de Obra</th>
                                                <th class="cell-300" scope="col">Cantidad de Tiempo</th>
                                                <th class="cell-300" scope="col">Tipo de Mano de Obra</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
