...
<body class="animsition site-menubar-disable-hover">
    ...
    <div class="page">
        <div class="page-header">
            <h1 class="page-title">Lista de Materia Prima Disponible para la Ficha Técnica Registrada en DaAnJu</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a>Inicio</a></li>
                <li class="breadcrumb-item"><a>Gestion de Ficha Técnica</a></li>
                <li class="breadcrumb-item"><a>Ver</a></li>
                <li class="breadcrumb-item"><a>Lista de Materia Prima</a></li>
            </ol>
        </div>
                                ...
                                <form method="POST" action="{{ action('FichaTecnicaController@saveManoObra') }}">
                                    ...
                                    <table class="table table-hover dataTable table-striped w-full" id="exampleTableTools">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                <th class="cell-300" scope="col">Materia Prima</th>
                                                <th class="cell-300" scope="col">Cantidad</th>
                                                <th class="cell-300" scope="col">Tipo de Materia Prima</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input name="cantidad" type="number" min="1" /></td>
