...
<body class="animsition page-profile">
  ...
  <div class="page">
        <div class="page-header">
            <h1 class="page-title">Lista de Usuario Registrado en DaAnJu</h1>
            <ol class="breadcrumb">
    ...
    <div class="panel">
      <div class="panel-body nav-tabs-animate nav-tabs-horizontal" data-plugin="tabs">
        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
          <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab" href="#profile" aria-controls="profile" role="tab"><h4>Datos del Usuario en DaAnJu</h4></a></li>
        </ul>

        <div class="tab-content">
          <div class="tab-pane active animation-slide-center" id="activities" role="tabpanel">
            <div class="tab-pane active" id="settings" role="tabpanel">
              <div class="card-body">
                <form class="form-horizontal form-material" method="post" action="{{ action('UserController@cambiarRole') }}">
                  @csrf
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input disabled type="text" name="id" value="{{ $user->id }}" class="form-control form-control-line">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="example-email" class="col-md-12">Nombre</label>
                    <div class="col-md-12">
                      <input disabled type="text" name="name" value="{{ $user->name }}" class="form-control form-control-line">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="example-email" class="col-md-12">Correo Electronico</label>
                    <div class="col-md-12">
                      <input disabled type="text" name="description" value="{{ $user->email }}" class="form-control form-control-line">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="example-email" class="col-md-12">Nombre del Role</label>
                    <div class="col-md-12">
                      <input disabled type="text" name="description" value="{{ $user->roles()->first()->name }}" class="form-control form-control-line">
                    </div>
                  </div>
                  <input type="hidden" name="user_id" value="{{ $user->id }}" />
                  <div class="modal-footer">
                    <button class="btn btn-success waves-effect">Cambiar Role</button>
                    <a class="btn btn-info waves-effect" href="{{route('user.index')}}" data-dismiss="modal">
                      Volver a Gestion de Usuarios en DaAnJu
                    </a>
                  </div>
