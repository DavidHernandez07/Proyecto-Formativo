...
<head>
    ...
    <title>Gestion Usuarios | DaAnJu Cost System</title>
    ...
    <link rel="stylesheet" href="examples/css/apps/contacts.css">
...
<div class="page">
  <div class="page-header">
    <h1 class="page-title">Lista de Usuarios Registrados en DaAnJu</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a>Inicio</a></li>
      <li class="breadcrumb-item"><a>Gestion de Usuarios</a></li>
  </ol>
</div>
...
<div class="page-content">
    ...
    <div class="panel-body">
        <table class="table table-hover dataTable table-striped w-full" id="exampleTableTools">
          <thead>
            <tr>
                ...
                <th class="cell-300" scope="col">Nombre del Role</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="cell-300">
                  <a class="avatar" href="javascript:void(0)">
                    <img class="img-fluid" src="/imagenes/{{ Auth::user()->avatar }}" alt="user" alt="">
                </a>
                {{$user->name}}
            </td>
            ...
            <td>
                <a type="button" class="site-action-toggle btn-raised btn btn-warning btn-floating front-icon fa fa-eye animation-scale-up" href="{{ route('user.show',['user'=>$user->id]) }}" aria-hidden="true"></a>
            </td>
            <td>
          ...
          <div class="modal-dialog modal-simple">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Ver Usuarios</h4>
            </div>
            <div class="modal-body">
                <form method="post" action="{{ action('UserController@cambiarRole') }}">
                   @csrf
                   <div class="form-group">
                     <input type="text" id="_id" name="id" disabled placeholder="Id" value="{{ $user->id }}" class="form-control">
                 </div>
                 <div class="form-group">
                        <input id="name" name="name" disabled placeholder="Nombre" value="{{ $user->name }}" class="form-control">
                    </div>
                    <div class="form-group">
                            <input id="email" name="description"  disabled placeholder="Descripción" value="{{ $user->email }}" class="form-control">
                        </div>
                        <div class="form-group">
                                <input id="rol" name="description"  disabled placeholder="Nombre del Role" value="{{ $user->roles()->first()->name }}" class="form-control">
                            </div>
                            <div class="modal-footer">
                                <button class="btn btn-info waves-effect" type="hidden" value="{{ $user->id }}" id="user_id" name="user_id">
                                    Cambiar Role
                                </button>
                                <a class="btn btn-default waves-effect" data-dismiss="modal">
                                    Cancelar
                                </a>
                            </div>                           
                        </form>
...
<script src="examples/js/apps/contacts.js"></script>
