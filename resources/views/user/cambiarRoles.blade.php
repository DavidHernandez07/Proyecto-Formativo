        ...
        <table class="table table-hover dataTable table-striped w-full" id="exampleTableTools">
          <thead>
            <tr>
                ...
                <th scope="col">Descripcion del Role</th>
            </tr>
        </thead>
        <tbody>
           @foreach($roles as $role)
            <tr>
                <td>
                    ...
                    <span class="custom-control-label"></td></span>
                     <td class="cell-300">{{$role->id}}</td>
                     <td class="cell-300">{{$role->name}}</td>
...
<center> <button class="btn btn-success waves-effect">Cambiar Role</button></center>
 </form>
</div>
</div>
