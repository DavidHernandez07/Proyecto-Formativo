...
<head>
    ...
    <title>Recuperar Contraseña | DaAnJu Cost System</title>
...
<body class="animsition page-login layout-full page-dark">
    ...
    <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
      ...
      <form method="POST" action="{{ route('password.update') }}">
        ...
        <div>
          <input readonly class="form-control form-control-user @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" require autocomplete="email" id="email" type="email" placeholder="Correo Electronico" autofocus" data-plugin="formMaterial">
          @error('email')
        ...
        <div class="form-group form-material floating" data-plugin="formMaterial">
          <input id="password" type="password" class="form-control form-control-user @error('password') is-invalid @enderror" name="password" placeholder="Contraseña" required autocomplete="new-password">
          @error('Contraseña')
          <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
          </span>
