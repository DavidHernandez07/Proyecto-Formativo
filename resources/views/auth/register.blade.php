...
<head>
  ...
  <title>Registro | DaAnJu Cost System</title>
    ...
    <div class="page-content vertical-align-middle">
      ...
      <form method="post" action="{{route('register')}}" autocomplete="off">
        ...
        <div class="form-group form-material floating" data-plugin="formMaterial">
          <input type="text" id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name"
          ...
          @enderror
          <label class="floating-label" for="inputName">Nombre</label>
        </div>
        <div class="form-group form-material floating" data-plugin="formMaterial">
          ...
          @enderror
          <label class="floating-label" for="inputEmail">Correo</label>
        </div>
        <div class="form-group form-material floating" data-plugin="formMaterial">
        ...
        <div class="form-group form-material floating" data-plugin="formMaterial">
          ...
          <label class="floating-label" for="inputPasswordCheck">Confirmar contraseña</label>
        </div>
