...
<body class="animsition site-menubar-disable-hover">
  ...
  <div class="page-header">
    <h1 class="page-title">Sección para Editar Panaderia en DaAnJu</h1>
    <ol class="breadcrumb">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            @if (Auth::user()->tieneRole('Super Administrador'))
                <form method="POSt" action="{{ route('panaderia.update',['panaderium'=>$panaderia->id]) }}">
                    {{ method_field('PUT') }}
                    @csrf
                    <div class="form-group">
                    <h2>Panaderia</h2>
                    ...
                    <input readonly type="number" class="form-control" name="id" value="{{ $panaderia->id }}" />
                    </div>   

                    <div class="form-group">
                    <label for="nit" class="control-label">{{'Nit'}}</label> 
                    <input type="number" class="form-control" name="nit" value="{{ $panaderia->nit }}" />
                    </div>   
                           
                    <div class="form-group">
                    <label for="nombre" class="control-label">{{'Nombre'}}</label> 
                    <input type="text" class="form-control" name="nombre" value="{{ $panaderia->nombre }}" />
                    </div>      
                       
                    <div class="form-group">
                    <label for="telefono" class="control-label">{{'Télefono'}}</label> 
                    <input type="number" class="form-control" name="telefono" value="{{ $panaderia->telefono }}" />
                    </div> 
                
                    <div class="form-group">
                    <label for="direccion" class="control-label">{{'Dirección'}}</label>     
                    <input type="text" class="form-control" name="direccion" value="{{ $panaderia->direccion }}" />
                    </div>        
                    <br>       
          
                    <button type="submit" class="btn btn-success" name="btnEnviar">Modificar</button>
                    <a class="btn btn-primary" href="{{ route('panaderia.index') }}">Volver</a><br><br>
