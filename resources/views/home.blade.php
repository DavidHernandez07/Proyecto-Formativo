...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="global/vendor/waves/waves.css">
        ...
        <link rel="stylesheet" href="examples/css/dashboard/v1.css">
...
<body class="animsition dashboard">
    ...
    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse"
      ...
      <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
          <img class="navbar-brand-logo" src="img/logo1.png" title="Remark">
      ...
      <div class="navbar-container container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
          ...
          <div class="navbar-brand navbar-brand-center">
            <a href="index.html">
              <img class="navbar-brand-logo navbar-brand-logo-normal" src="img/logo.png"
                title="Remark">
              <img class="navbar-brand-logo navbar-brand-logo-special" src="img/logo.png"
                title="Remark">
            </a>
          </div>
        </div>
  ...
  <!-- Footer -->
    ...
    <script src="global/js/Plugin/switchery.js"></script>
        ...
        <script src="examples/js/dashboard/v1.js"></script>
  </body>
</html>