...
<head>
  ...
  <title> Home | DaAnJu Cost System</title>
  ...
  <link rel="stylesheet" href="examples/css/pages/email.css">
        ...
        <div class="panel-body container-fluid">
          ...
          <div class="card welcome-content">
            <div class="card-block pl-40 pr-40  mt-30 mb-30">
              <h2>Bienvenido a DaAnJu Cost System!</h2><br><br>
              <p>Este sistema recolecta los costos  que intervienen en el proceso de transformación de una cantidad especifica de productos, maquinaria,
            reparaciones u otros servicios, se recopilan sucesivamente por los
            elementos identificables: Materia prima aplicable directa e indirecta, mano de obra directa e indirecta y otros 
            cargos indirectos, se suman a cada producto determinando el precio adecuado para su posterior venta.</p>
