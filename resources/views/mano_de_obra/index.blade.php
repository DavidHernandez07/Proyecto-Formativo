...
-->
  ...
  <div class="page-header">
    <h1 class="page-title">Lista de Mano de Obra Registrada en DaAnJu</h1>
    <ol class="breadcrumb">
    ...
    <div class="panel-body">
                ...
                <table>
                    <tr>
                        <td>
                            @if (Auth::user()->tieneRole('Super Administrador'))
                            <a class="btn btn-primary" href="{{ route('mano_de_obra.create') }}">Agregar Mano de Obra</a>
                            @endif
                         </td>
                    </tr>
                </table>
                ...
                <table class="table table-hover dataTable table-striped w-full" id="exampleTableTools">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="cell-300" scope="col">Tiempo</th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="post" action="{{ route('mano_de_obra.destroy',['mano_de_obra'=>$mo->id]) }}">
                                    @csrf
                                    {{ method_field('delete') }}
                                    <button class="btn btn-danger" type="submit" onclick="return confirm('¿Desea eliminar la mano de obra?');">Eliminar</button>
                                </form>
                                @endif
                            </td>
                        </tr>
